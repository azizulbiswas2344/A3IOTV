...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://i.ibb.co/KGkDt2b/newlogoazizulscanner.jpg'))
# WISH_PICS = (environ.get('WISH_PICS', 'https://i.ibb.co/VNB60cK/Untitled-design-20241231-135231-0000.png')).split()

# payment
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://i.ibb.co/KGkDt2b/newlogoazizulscanner.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/A3IOTV/186') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'LazyDeveloper')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [A3IOTV™](https://t.me/A3IOTV)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>🧩{file_size}\n\n💃")
...
DOWNLOAD_TEXT_URL = "https://t.me/A3IOTV"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/A3IOTV"
